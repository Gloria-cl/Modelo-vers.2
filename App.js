...
<head>
    ...
    <title>Modelo de Estrategias de Viabilidad para Espacios Públicos</title>
    <style>
        * {
...
<body>
    <div class="header">
        <h1>Modelo de Estrategias de Viabilidad para Espacios Públicos</h1>
        <p>Priorización Estratégica - Diagnóstico</p>
    </div>

    <div class="main-container">
        <div class="panel left-panel">
            <h3>Selecciona las categorías presentes en tu espacio</h3>
        ...
        <div class="panel">
            ...
            <div class="stats-container">
                ...
                <div class="stats-label">Índice de Viabilidad</div>
                <div class="stats-detail" id="stats-detail">0 de 22 categorías</div>
            </div>
    ...
    <div class="controls">
        ...
        <button class="control-btn" id="btn-diseno" style="--color: #9966ff">Diseño</button>
        <button class="control-btn" id="btn-construccion" style="--color: #95ca49">Construcción</button>
        <button class="control-btn" id="btn-gestion" style="--color: #5c8fe6">Gestión</button>
        <button class="control-btn" id="btn-rehabilitacion" style="--color: #5cd6d6">Rehabilitación</button>
        
        <div style="width: 20px;"></div>
        
        <button class="control-btn" id="btn-actual">📊 Diagnóstico Actual</button>
    ...
    <div class="footer">
        <p><strong>Interpretación de valores: 3 = Esencial | 2 = Importante | 1 = Complementario</strong></p>
    </div>
    ...
    <script>
        ...
        function updateStats() {
            ...
            document.getElementById('stats-detail').textContent = `${selected} de ${total} categorías`;
        ...
        function updateRecommendations() {
            ...
            if (selected === 0) {
                container.innerHTML = '<div class="empty-state">Selecciona las categorías presentes en tu espacio para ver las recomendaciones</div>';
                return;
            }

            if (selected === total) {
                container.innerHTML = '<div class="success-state">¡Excelente! Tu espacio cuenta con todas las categorías de viabilidad.</div>';
                return;
            }
        ...
        function renderChart() {
            ...
            dropShadow.setAttribute('flood-color', 'rgba(0,0,0,0.2)');
            ...
            Object.entries(dataPorCuadrante).forEach(([cuadrante, datos]) => {
                datos.forEach(item => {
                    ...
                    text.textContent = item.nombre.length > 16 ? item.nombre.substring(0, 16) + '...' : item.nombre;
                    svg.appendChild(text);
                });
            });
            ...
            Object.entries(dataPorCuadrante).forEach(([cuadrante, datos]) => {
                datos.forEach(item => {
                    ...
                    const tamaño = 5 + valor * 3;

                    const circle = document.createElementNS('http://www.w3.org/2000/svg', 'circle');
                    circle.setAttribute('cx', x);
                    circle.setAttribute('cy', y);
                    circle.setAttribute('r', tamaño);
        ...
        function setupControls() {
            ...
            document.getElementById('btn-construccion').addEventListener('click', () => {
                cuadranteSeleccionado = "Construcción";
            ...
            document.getElementById('btn-rehabilitacion').addEventListener('click', () => {
                cuadranteSeleccionado = "Rehabilitación";
